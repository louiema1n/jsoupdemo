...
//            page.setSkip(true);
//        }
        page.putField("readme", page.getHtml().css("body > div.complex > div > div.modular > div > div.mixture > ul > li > a.tt").all());
...
//        page.addTargetRequests(page.getHtml().links().regex("(https://github\\.com/\\w+/\\w+)").all());
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new GithubRepoPageProcessor()).addUrl("https://zhibo.sogou.com/").thread(5).run();
    }
}
